 ...
 * @author MENDOZA
 */
public class SeparaCita extends javax.swing.JFrame {

    /**
     * Creates new form SeparaCita
     */
    public SeparaCita() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Datos del paciente (Paciente que va a pasar consulta)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeparaCita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeparaCita().setVisible(true);
            }
        });
    }
